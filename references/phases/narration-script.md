...
- 3-10 分钟、`speech_rate=1.4` 下约 **8.75 字符/秒** → `3min ≈ 1575 chars`、`5min ≈ 2625 chars`、`10min ≈ 5250 chars`。
- 段间用空行分隔，每段约对应一个 scene = **5-8 秒音频**（在 `speech_rate=1.4` / 8.75 字符/秒下约 44-70 字符/段）。按目标时长伸缩，参考量：3min ≈ 23-36 段、5min ≈ 38-60 段、10min ≈ 75-120 段。
