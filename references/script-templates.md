...
Templates for the 4 most common video genres. Each is sized for ~85s at `speech_rate=1.3` (originally ~75s at the old `speech_rate=1.5` default — same script text, slower playback).
