...
| sub-agent 支持（Phase 8） | 优先使用当前客户端原生的 sub-agent / 委派工具。仅当用一句短 prompt 让 agent 自己读 `composition-handoff.md`、工作区本地 `references/composition-rules.md`、`references/animation-routing.md` 与 `references/composition-stage-protocol.md` 时，CLI fallback 才可接受 |
